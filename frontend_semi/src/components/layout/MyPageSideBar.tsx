...
function MyPageSideBar() {
  ...
  const isMember = location.pathname === "/memberinfo/mypage/";
  const isLearning = location.pathname === "/memberinfo/mypage/learning/";
  const isFavorite = location.pathname === "/memberinfo/mypage/favorite/";
//===========================================================================
  ...
  return (
    <aside className="mypage-sidebar">
      ...
      <button
        ...
        onClick={()=> navigate("/memberinfo/mypage/learning/")}
      >
        <span >01</span>
            학습정보
     </button>
      ...
      <button
        ...
        onClick={()=>navigate("/memberinfo/mypage/favorite/")}
      >
        <span>03</span>
            즐겨찾기
      </button>
